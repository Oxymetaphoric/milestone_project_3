...
class Game(db.Model):
    ...
    release_date = db.Column(db.DateTime,  default = datetime.now(timezone.utc), nullable = False) 
...
class Review(db.Model):
    ...
    review_created_at = db.Column(db.DateTime, nullable = False, default = datetime.now(timezone.utc)) 
...
class UserGame(db.Model):
    ...
    added_at = db.Column(db.DateTime, nullable=False, default = datetime.now(timezone.utc))
